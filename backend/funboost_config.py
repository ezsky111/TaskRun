...
class BrokerConnConfig(DataClassBase):
    ...
    MONGO_CONNECT_URL = os.getenv('MONGO_CONNECT_URL', 'mongodb://127.0.0.1:27017') # 如果有密码连接 'mongodb://myUserAdmin:XXXXX@192.168.199.202:27016/'   authSource 指定鉴权db，MONGO_CONNECT_URL = 'mongodb://root:123456@192.168.64.151:27017?authSource=admin'
